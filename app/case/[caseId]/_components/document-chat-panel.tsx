...
export function DocumentChatPanel({ caseId, initialMessages, onLoadingChange }: DocumentChatPanelProps) {
          ...
          {messages.length === 0 && !isLoading ? (
            <div className="h-full flex items-center justify-center text-stone-400 dark:text-stone-500">
              <div className="text-center">
                <p className="text-lg font-medium">Document review</p>
                <p className="text-sm mt-1">
                  Ask about your documents, gaps, and quality
                </p>
              </div>
            </div>
          ) : (
